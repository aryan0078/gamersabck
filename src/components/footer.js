      ...
      <div className={styles.main}>
        <div className={styles.taglineholder}>
          ...
          <h1 className={styles.tagline2}>
            Are you who are ? Come join us at Gamersback.Click here to check
            career points
          </h1>
        </div>
        <div className={styles.linksholder}>
          ...
          <div className={styles.section}>
            ...
            <a style={{ color: "grey" }}>
              Loremp ipsum lorem ipsum loremp ipsum
            </a>
            <a style={{ color: "grey" }}>
              Loremp ipsum lorem ipsum loremp ipsum
            </a>
        ...
        <div className={styles.socialmediandnle}>
          <div className={styles.socaillinks}>f g t y</div>
          <div className={styles.newsletter}>
            ...
            <div className={styles.inputbuttonholders}>
              ...
              />
              <button className={styles.nbutton}>SUBSCRIBE</button>
            </div>
          </div>
        </div>
      </div>
