...
export default class Landing extends Component {
  ...
  menu = (
    <Menu>
      <Menu.Item key="0">
        <Link to="/dashboard">
          <a className={styles.dropitem}>Dashboard</a>
        </Link>
      </Menu.Item>
      <Menu.Item key="0">
        <Link to="/dashboard">
          ...
          <Content>
            {this.props.cp ? (
              <Drawer
                ...
                <div className={styles.cevent}>Overview</div>
                <div className={styles.cevent}>Booked Tickets</div>
                <div className={styles.cevent}>Cancellation</div>
                <div className={styles.cevent}>Current Events</div>
                <div className={styles.cevent}>Create Events</div>
