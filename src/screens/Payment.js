        ...
        <div className={styles.paymentcontainer}>
          <div className={styles.row1}>
            <div className={styles.eventname}>
              ...
              <h1 className={styles.placenlocation}>
                location <CalendarOutlined /> Gyanpur{" "}
              </h1>
            </div>
            <div className={styles.dropdown}>
              <Select
                ...
                style={{ width: 350, backgroundColor: "black", color: "white" }}
              >
                <Option
                  style={{ backgroundColor: "transparent", color: "#de2358" }}
                >
                  Select something
                </Option>
              </Select>
            ...
            <div class={styles.quantityinput}>
              <span class={styles.minus} onClick={this._quantitym}>
                -
              </span>
              <input
                class={styles.input}
                ...
                disabled=""
              />
              <span class={styles.plus} onClick={this._quantityp}>
                +
              </span>
            </div>
          </div>
        ...
        <div className={styles.paymentdetails}>
          ...
          <div className={styles.row5}>
            ...
            <p className={styles.longtext}>
              ...
              sell, rent, lease or give away your information to any third
              party. Nor will we send you unsolicited email.
            </p>
          </div>
          <div className={styles.row6}>
            ...
            <p className={styles.longtext}>
              ...
              Secure Sockets Layer protocol. You can trust us!
            </p>
          </div>
        </div>
      </div>
